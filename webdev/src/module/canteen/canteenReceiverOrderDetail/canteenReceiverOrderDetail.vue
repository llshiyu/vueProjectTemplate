<template>
    <div class="canteen-receiver-detail" v-if="response">
        <el-breadcrumb separator="/" class="order-breadcrumb">
            <el-breadcrumb-item>订单管理</el-breadcrumb-item>
            <el-breadcrumb-item :to="{ path: '/canteenReceiverOrder' }">我的收货单</el-breadcrumb-item>
            <el-breadcrumb-item>收货单详情</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="order-detail-box">
            <div class="order-title-box clearfix">
                <div class="order-title fl">收货单详情</div>
