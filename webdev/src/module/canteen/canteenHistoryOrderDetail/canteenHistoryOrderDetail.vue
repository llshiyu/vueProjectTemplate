<template>
    <div class="canteen-history-detail">
        <el-breadcrumb separator="/" class="order-breadcrumb">
            <el-breadcrumb-item>订单管理</el-breadcrumb-item>
            <el-breadcrumb-item :to="{ path: '/canteenHistoryOrder' }">历史订单</el-breadcrumb-item>
            <el-breadcrumb-item>订单详情</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="order-detail-box">
            <div class="order-title-box clearfix">
                <div class="order-title fl">订单详情</div>
                    ...
                    <div class="detail-table-box">
                        ...
                        <div class="table-tbody">
                            <div class="cont-tr flex-box" v-for="(item,index) of detailData.subOrderGoodsList" :key="index">
                                <div class="flex-1 cont-td shop-name padding-left22 border-bottom">
                                    {{item.goodsName}}
                                </div>
                                <div class="text-align-center cont-td width130 border-bottom">{{item.goodsTypeName}}</div>
                                ...
                                <div class="text-align-center cont-td width150"
                                    ...
                                    {{index===0?'￥'+detailData.needTotalPrice.toFixed(2):''}}
                                </div>
                            </div>
                            <div class="cont-foot">
                            <span class="foot-div">商品总数<span
                                    class="price-size">{{detailData.needTotalNum}} 件</span></span>
                                <span class="foot-div">总金额<span class="price-size" v-if="detailData.needTotalPrice"><span class="small-size">￥</span>{{detailData.needTotalPrice.toFixed(2)}}</span></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            printOrder() {
                ...
                // var sprnstr = "<!--printBegin-->";
                // var eprnstr = "<!--printEnd-->";
                // var prnhtml = bdhtml.substring(bdhtml.indexOf(sprnstr));
