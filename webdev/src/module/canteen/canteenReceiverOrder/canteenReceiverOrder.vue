<template>
    <div class="canteen-receiver-order" v-if="response">
        <el-breadcrumb separator="/" class="order-breadcrumb">
            <el-breadcrumb-item>订单管理</el-breadcrumb-item>
            <el-breadcrumb-item>我的收货单</el-breadcrumb-item>
        </el-breadcrumb>
        <!--样式在assets/css/order-->
        ...
        <div class="order-list">
            <div class="table-thead flex-box">
                ...
                <div class="text-align-center table-th width130">需求量</div>
                <div class="text-align-center table-th width130">实际收货量</div>
            ...
            <div v-if="orderList&&orderList.length>0">
                <div class="order-box" :class="item.subOrderList.length>1?'has-border':''"
                    ...
                    <div class="parent-title">
                        ...
                        <span>收货时间：{{item.takeTime | analyseTime('6')}}</span>
                    </div>
                    <div class="child-box" v-for="(item2,index2) of item.subOrderList" :key="index2">
                        <div class="child-title">
                            ...
                            <span>送达时间：{{item2.sendToTime | analyseTime('6')}}</span>
                            <span>收货时间：{{item2.takeTime | analyseTime('6')}}</span>
                        ...
                        <div class="child-cont">
                            <div class="cont-tr flex-box" v-for="(item3,index3) of item2.subOrderGoodsList" :key="index3">
                                <div class="flex-1 cont-td clearfix flex-box"
                                    ...
                                    <img src="../../../assets/img/img.png" class="shop-img fl">
                                ...
                                <div class="text-align-center cont-td border-right width130"
                                     :class="index3!==(item2.subOrderGoodsList.length-1)?'border-bottom':''">
                                    <div class="td-txt">{{item3.goodsRealNum}}</div>
                                </div>
                                <div class="text-align-center cont-td border-right width150"
                                     :class="index3===item2.subOrderGoodsList.length?'border-bottom':''">
                                    <i class="price-size td-txt" v-if="index3===0"><span class="small-size">￥</span>{{item2.realTotalPrice.toFixed(2)}}</i>
                                </div>
                                <div class="text-align-center cont-td width150"
                                    ...
                                    <div class="td-txt" v-if="index3===0">
                                        ...
                                        <div class="cursor-pointer td-btn td-margin-top"
        ...
        <!--查看收货单弹窗-->
        <RecevierOrder isOrder="true" :myOrderList="myOrderList" :dialogOrder="dialogOrder"
