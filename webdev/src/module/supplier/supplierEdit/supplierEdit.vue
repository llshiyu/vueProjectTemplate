<template>
    <div class="supplier-enter">
        ...
        <el-breadcrumb separator="/" class="order-breadcrumb">
            ...
            <el-breadcrumb-item :to="{ path: '/supplierEdit' }">商品编辑</el-breadcrumb-item>
        </el-breadcrumb>
        ...
        <div class="list-type " style="margin-top: 40px">
            ...
            <el-select :disabled="disabledE" v-model="cargoObj.firstTypeValue" placeholder="一级分类" @change="getSecondList">
                <el-option
            ...
            <el-select :disabled="disabledE" style="margin-left: 15px" v-model="cargoObj.secondTypeValue" placeholder="二级分类" @change="getThirdList">
                <el-option
            ...
            <el-select :disabled="disabledE" v-show="isShowThirdSelect" style="margin-left: 15px" v-model="cargoObj.thirdTypeValue" placeholder="三级分类" @change="getSome">
                <el-option
        ...
        <div class="list-type no-mgb">
            ...
            <div class="right-text" style="display: inline-block">
                ...
                <el-select :disabled="disabledE"  style="width: 120px;margin-left: 20px"  v-model="cargoObj.netContentUnit" placeholder="请选取单位">
                    <el-option
            ...
            <div class="right-text" style="display: inline-block">
                <el-form style="display: inline-block" :model="cargoObj" :rules="rules" ref="ruleForm" >
                    <el-form-item  prop="brand">
                        <el-input type="text" :disabled="disabledE" v-model="cargoObj.brand" placeholder="请输入商品品牌" maxlength="10"></el-input>
                    </el-form-item>
                </el-form>
            </div>
        ...
        <p class="left-text">
            ...
            <div class="right-text" style="display: inline-block">
                ...
                <el-select class="el-select-mid" :disabled="disabledE"  v-model="cargoObj.imported" placeholder="请选择">
                    <el-option
            ...
            <div class="right-text" style="display: inline-block">
                ...
                <el-form style="display: inline-block" :model="cargoObj" :rules="rules" ref="ruleForm" >
                    <el-form-item  prop="category">
                        <el-input type="text" disabled v-model="cargoObj.category" placeholder="请输入品种" maxlength="10"></el-input>
                    </el-form-item>
                </el-form>
            </div>
        </div>
        ...
        <p class="left-text">
            ...
            <div class="right-text" style="display: inline-block">
                ...
                <el-select class="el-select-mid" :disabled="disabledE"  v-model="cargoObj.storageStatus" placeholder="请选择">
                    <el-option
        ...
        <p class="left-text">
            ...
            <div class="right-text" style="display: inline-block">
                ...
                <el-select class="el-select-mid" :disabled="disabledE"  v-model="cargoObj.feedingMode" placeholder="请选择">
                    <el-option
        ...
        <div class="list-type" v-if="cargoObj.firstTypeValue==8626">
            ...
            <div class="right-text" style="display: inline-block">
                ...
                <el-select class="el-select-mid"  :disabled="disabledE" v-model="cargoObj.waters" placeholder="请选择">
                    <el-option
...
<script>
    ...
    export default {
        ...
        beforeRouteEnter(to, from, next) {
            ...
            if(from.name==='supplierPreview'||from.name==='supplierPreviewGoods'){
                _sessionStorage('isNeedGetData1','notNeed')
            }else{
                _sessionStorage('isNeedGetData1','need')
            }
            next(vm => {
        ...
        activated(){
            this.isNeedGetData = _sessionStorage('isNeedGetData1')||'need'

            if(this.isNeedGetData!=='notNeed'){
                this.clean()
                this.getTypeList()
                this.getGoodsInfoFun()
                this.getUnitList()
...
//                sessionData
                ...
                this.$router.push({name:'supplierPreviewGoods'})
            },
...
//                this.goodsId = this.$route.params.id
            ...
            getGoodsInfoFun(){
                ...
                _sessionStorage('previewId',this.goodsId)
//                var _this = this;
                var param = {
                    "id": this.goodsId
                };
