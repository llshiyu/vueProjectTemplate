<template>
    <div class="detail-pack">
        <el-breadcrumb separator="/" class="order-breadcrumb">
            ...
            <el-breadcrumb-item :to="{ path: '/supplierEdit',query:{id:id} }">商品编辑</el-breadcrumb-item>
            <el-breadcrumb-item :to="{ path: '/supplierPreview' }">预览商品详情</el-breadcrumb-item>
        </el-breadcrumb>
...
<script>
    import js from "./supplierPreviewGoods.js"
    export default js
</script>
