<template>
    <div class="supplier-history-detail" v-if="response">
        <el-breadcrumb separator="/" class="order-breadcrumb">
            <el-breadcrumb-item>订单管理</el-breadcrumb-item>
            <el-breadcrumb-item :to="{ path: '/supplierHistoryOrder' }">历史订单</el-breadcrumb-item>
                    ...
                    <div class="detail-table-box">
                        ...
                        <div class="table-tbody">
                            ...
                            <div class="cont-foot">
                                ...
                                <span class="foot-div">总金额<span class="price-size"><span class="small-size">￥</span>{{detailData.needTotalPrice.toFixed(2)}}</span></span>
                            </div>
                        </div>
                    </div>
                </div>
