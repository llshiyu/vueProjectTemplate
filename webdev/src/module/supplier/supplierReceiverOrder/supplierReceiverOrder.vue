<template>
    <div class="supplier-receiver-order" v-if="response">
        <el-breadcrumb separator="/" class="order-breadcrumb">
            <el-breadcrumb-item>订单管理</el-breadcrumb-item>
            <el-breadcrumb-item>买家收货单</el-breadcrumb-item>
        </el-breadcrumb>
        <!--样式在assets/css/order-->
                ...
                <div class="order-box supplier-order-box">
                    <div class="child-box" v-for="(item2,index2) of orderList" :key="index2">
                        <div class="child-title">
                            ...
                            <span style="">收货时间：{{item2.takeTime | analyseTime('6')}}</span>
        ...
        <!--查看收货单弹窗-->
        <RecevierOrder isOrder="true" isSupplier="true" :myOrderList="myOrderList" :dialogOrder="dialogOrder"
        ...
        methods: {
            ...
            getOrderList() {
                let param = {
                    ...
                    // supplierName: "",  // 供应商名
                    takeStatus: 1  // 0:我的订单 1：历史订单和我的收货单     返回值中takeStatus 0-未确认收货  1-采购商确认收货  2-供应商收货
                };
