<template>
  <div class="paging-container clearfix">
    ...
    <!--<div class="select-box cont-box">-->
      ...
      <!--&lt;!&ndash;<div class="select-box"><select name="select" v-model="selectShowNumber" @change="clickPage(1)">&ndash;&gt;-->
        <!--&lt;!&ndash;<option :value="item" v-for="(item,index) of selectShowNumberList" :key="index">{{item}}</option>&ndash;&gt;-->
    ...
    <div class="li-box cont-box">
      <div class="clearfix">
        ...
        <div class="fl li-ul-box">
          <ul class="clearfix">
            <li class="fl" :class="{'active':showActivePageIndex===item}" @click="clickPage(item)"
...
<script>
  export default {
    ...
    watch: {
      ...
      showActivePageIndex:function (val) {
        this.inputVal = val;
        this.thisPage = val;
        this.computedTabArr(val);
      }
    },
    methods: {
      init() {
...
<style lang="less" type="text/less" scoped>
  ...
  .paging-container {
    ...
    .li-box {
      ...
      .li-div:hover,.li-ul-box li:hover{
        background: #3F94FC;
        border-color: #3F94FC;
        color: #FFFFFF;
      }
      .li-ul-box li.active:hover{
        background: #FFFFFF;
        border-color: #EAEDF1;
      }
      .li-ul-box {
